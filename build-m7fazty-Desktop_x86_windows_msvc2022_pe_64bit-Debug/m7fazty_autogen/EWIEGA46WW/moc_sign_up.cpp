...
Q_CONSTINIT const QMetaObject sign_up::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSsign_upENDCLASS_t,
        ...
        // method 'on_sign_up2_button_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void sign_up::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: { bool _r = _t->isStrongPassword((*reinterpret_cast< std::add_pointer_t<string&>>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 1: _t->on_back_button_clicked(); break;
        case 2: _t->on_sign_up2_button_clicked(); break;
        default: ;
        }
    }
}
