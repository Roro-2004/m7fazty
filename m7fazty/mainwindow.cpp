...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent) , ui(new Ui::MainWindow)
{
    ...
    files::read_from_file("D:/level 2 projects/m7fazty/m7fazty/files/Transiction.csv");
    ...
    files::read_from_file("D:/level 2 projects/m7fazty/m7fazty/files/User.csv");
...
{
    files::write_in_file("D:/level 2 projects/m7fazty/m7fazty/files/User.csv");
    files::write_in_file("D:/level 2 projects/m7fazty/m7fazty/files/Transiction.csv");
