...
void files::write_in_file(string file_path) {
    ...
    if (fs::file_size(path) == 0) {
        ...
        } else if (path.string() == "C:/Users/Essam/Desktop/git test/m7fazty/m7fazty/files/User.csv") {
...
void files::read_from_file(const string& file_path) {
    ...
    while (getline(inputFile, line)) {
        ...
        if (!line.empty()) {
            if (file_path == "C:/Users/Essam/Desktop/git test/m7fazty/m7fazty/files/Transiction.csv") {
                split(line, "tr");
            } else if (file_path == "C:/Users/Essam/Desktop/git test/m7fazty/m7fazty/files/User.csv") {
                split(line, "ur");
            }
        }
    }
