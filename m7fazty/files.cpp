...
void files::write_in_file(string file_path) {
    ...
    // write headers only low el file fady
...
void files::split(const string& s, const string& path) {
    ...
    //getline extracts substrings delimited by the character , from the stringstream and stores each substring in the temp variable.
